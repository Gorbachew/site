...
function pushbtn()
{
  ...
  currency = $('#plus_button').attr('src');
  // Проверяет ссылку на иконку, если равна иконке своего номинала то прибавляет сумму.
  if (currency == '/static/click/img/icon/coin.png'){
    currency = 1;
...
//   }
//   else{
//     $("#plus_button").attr("src","/static/click/img/icon/coin.png");
//     return 1;
//   }
// }
...
//   }
// }
// // Вероятно, это мужики которые делали лапти и набирали счет
...
function check(value)
{
  $.ajax(
      ...
      async: false,
        ...
        // Подразумивалось, что проверять можно счет или номинал. Value и есть обозначение этого
